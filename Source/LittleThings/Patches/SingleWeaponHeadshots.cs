...
namespace LittleThings.Patches
{
    class SingleWeaponHeadshots
    {
                ...
                try
                {
                    ...
                    if (___displayedLocation == ArmorLocation.None)
                    {
                        ...
                        if (
                            ...
                            ___HUD.CalledShotPopUp.ShownAttackDirection == AttackDirection.FromBack ||
                            ___HUD.SelectedTarget.IsShutDown ||
                            ___HUD.SelectedTarget.IsProne
                        )
                        {
                            return;
                        }
        ...
        /*
        // Only to fix small UI problems with the decription text box resizing...
        ...
        public static class SelectionStateFire_FireButtonString_Patch
        {
            ...
            public static void Postfix(SelectionStateFire __instance, ref string __result)
            {
                try
                {
                    ...
                    {
                        Logger.LogLine("[SelectionStateFire_FireButtonString_POSTFIX] Appending headshot note...");
